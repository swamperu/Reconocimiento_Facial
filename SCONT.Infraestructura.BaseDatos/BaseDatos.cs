...
namespace SCONT.Infraestructura.BaseDatos
{
    ...
    public static class BaseDatos
    {
        ...
        /// (ConnectionString)
        /// </summary>
        public static SqlConnection GetConnection(string nroConexion = "")
        {
            string connectionString = ConfigurationManager.ConnectionStrings["ConnectionString" + (nroConexion == "" ? "SIGA" : "") + nroConexion].ConnectionString;
        ...
        // ''' (ConnectionString)
        // ''' </summary>
        //Public Shared Function GetConnection(ByVal nuevaConnectionString As String) As SqlConnection
        ...
        public static SqlDataReader GetDataReader(SqlCommand cmd, string nroconexion = "")
        {
            ValidCommand(cmd);
        ...
        /// <summary>
        /// Metodo utilizado para la lectura de datos. Devuelve un objeto SqlDataReader.
        /// </summary>
        /// <param name="instruccionSQL">instruccion Sql a ejecutar</param>
        public static SqlDataReader GetDataReader(string instruccionSQL, string nroconexion = "")
        {
        ...
        /// 3. Parameters (si los hubiera)
        /// </param> 
        public static DataSet GetDataSet(SqlCommand cmd, string nroconexion = "")
        {
            ValidCommand(cmd);
            ...
            using (SqlConnection cn = GetConnection(nroconexion))
            {
                cmd.Connection = cn;
        ...
        /// 3. Parameters (si los hubiera)
        /// </param> 
        public static object GetDataScalar(SqlCommand cmd, string nroconexion = "")
        {
            ValidCommand(cmd);
        ...
        public static int Execute(SqlCommand cmd, string nroConexion = "")
        {
            ValidCommand(cmd);
        ...
        /// </param>
        /// <returns>Número de registros afectados</returns>
        public static int Execute(SqlCommand cmd, SqlTransaction transaction)
        {
            ValidCommand(cmd);
        ...
        /// </summary>
        private static bool ValidCommand(SqlCommand cmd)
        {
            if (cmd == null)
                throw new ArgumentException("Debe proporcionar un objecto SqlCommand");
